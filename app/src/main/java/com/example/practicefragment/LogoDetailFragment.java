...
public class LogoDetailFragment extends Fragment {
    ...
    public static LogoDetailFragment newInstance(Logo logo) {
        ...
        args.putString("description", logo.description);
        args.putInt("image", logo.avatar);
        fragment.setArguments(args); //set 1 đối tượng
        return fragment;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            logoDetail = new Logo(getArguments().getString("name"), getArguments().getString("description"),
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        imageView.setImageResource(logoDetail.avatar);
        txtName.setText(logoDetail.name);
        txtDescription.setText(logoDetail.description);
    }
}